...
import edu.cmu.cs214.hw3.player.AIPlayer;
import edu.cmu.cs214.hw3.player.GameActions;
import edu.cmu.cs214.hw3.player.Player;
import edu.cmu.cs214.hw3.player.godCards.GodCardFactory;

/**
 * The game controller that handles all the user interactions.
 * Each instance is an immutable state of a running game, comprising:
 * (1) players: list of {@link Player};
 * (2) board: a copy of the game {@link Board};
 * (3) round: a round counter identifying the progress and current player;
 * (4) stage: a {@link GameStage} token representing the user's next step;
 * (5) history: a complete {@link Game} traces of all the previous steps
 * 
 * @author Zixuan Chen
 */
