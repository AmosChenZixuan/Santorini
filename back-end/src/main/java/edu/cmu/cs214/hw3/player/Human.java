...
/**
 * This class implements the basic game actions.
 * It is designed to be extended by other classes that represent specific god cards, 
 * each of which will implement its own special actions 
 * 
 * @author Zixuan Chen
 */
