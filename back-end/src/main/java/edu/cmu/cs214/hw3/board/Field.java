...
/**
 * A Field object represents a space on the game board
 * 
 * It may contain a tower represented by "level" ranged from 0 to 3:
 * Level-0 means no tower, Level-3 means full tower.
 * 
 * It may contain either a dome or an occupant worker. 
 * 
 * 
 * @author Zixuan Chen
 */
