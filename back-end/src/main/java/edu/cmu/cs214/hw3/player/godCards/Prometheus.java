...
/**
 * This God Card may build both before and after move.
 * However, if he choose to build before move, he cannot move up in this round.
 * 
 * His ability is activated during entire MOVE stage
 * His ability can use one time per round 
 * 
 * @author Zixuan Chen
 */
