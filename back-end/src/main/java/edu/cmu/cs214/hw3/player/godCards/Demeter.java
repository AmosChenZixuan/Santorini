...
/**
 * This God Card may build twice in one turn.
 * Her ability is activated after first build and deactivated after BUILD stage.
 * Her ability can use one time per round 
 * 
 * @author Zixuan Chen
 */
