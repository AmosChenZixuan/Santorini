...
/**
 * A game board that contains a collection of {@link Field}.
 * Individual Fields are accessed using id or index, which can be translated into a 2D coordinate.
 * The coordinate origin is located at the top-left corner of the grid. 
 * 
 * +---+---+---+---+---+            +---+---+---+---+---+
 * |0,0|0,1|   |   |   |            | 0 | 1 |   |   |   |
 * +---+---+---+---+---+            +---+---+---+---+---+
